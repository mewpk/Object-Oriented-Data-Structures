# Chapter : 5 - item : 2 - Nasa ก็พาเธอกลับมาไม่ได้เธอไปนอกใจ ไม่ได้ไปนอกโลก
# พี่บ่าวสงสัยหลักการทำงานของการ forward และ backward ของ browser 
#เลยไปทำการศึกษามาปรากฎว่ามันใช้หลักการของ linkedlist ซึ่งบังเอิญตรงกับเนื้อหาที่น้องๆ 2D กำลังศึกษาอยู่พอดี 
#พี่เลยอยากให้น้องๆรู้ว่าจริงๆแล้ว linkedlist นั้นมีประโยชน์มากๆเลย โดยหลักการทำงานมันมีอยู่ว่าหากเราเข้า
# a.com แล้วไป b.com ต่อและอยากกลับมาหน้าเดิมก็กดปุ่ม backward ก็จะกลับมาที่ a.com และหากเข้า c.com แล้วย้อนกลับมา 
#ก็จะกลับมาได้แค่ a.com ไม่ว่าเราจะย้อนสักกี่ครั้ง b ก็ไม่กลับมา
...
# ปล. โดยทุกการเข้า URL จะเริ่มที่หน้า welcome ของ browser เสมอ แต่ไม่ต้องนำไปใส่ใน history หรือ
# backpath ดูตัวอย่างได้ที่ TestCase 2
